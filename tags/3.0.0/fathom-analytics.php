...
function fathom_print_js_snippet() {
  ...
  <?php if (empty(fathom_get_custom_domain())): ?>
    <script src="https://cdn.usefathom.com/script.js" site="<?php echo esc_attr( $site_id ); ?>"></script>
   <?php else: ?>
    <script src="https://<?php echo str_replace(['http://', 'https://', '/'], '', fathom_get_custom_domain()); ?>/script.js" site="<?php echo esc_attr( $site_id ); ?>"></script>
   <?php endif; ?>
   <!-- / Fathom -->
   <?php
}
